...
demo = gr.Interface(
    ...
    description=(
        ...
        "⚠️ Это учебный проект, не используйте его результаты как единственное "
        "основание для того, чтобы есть найденные грибы — при малейшем сомнении "
        "консультируйтесь со специалистом-микологом."
    ),
    examples=None,
)
